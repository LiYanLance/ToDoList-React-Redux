...
const defaultItems = [
    ...
    {id: 2, name: "Action 2", tags:[], dueDate:"2018-10-02", status: Action.STATUS.TODO},
    {id: 3, name: "Action 3", tags:[Action.TAG.LEARNING], dueDate:"2018-10-03", status: Action.STATUS.TODO},
